...
---
Zongfang Liu is a Computer Vision Algorithm Engineer of [MetaVision Project Group](https://www.huaweicloud.com/intl/en-us/product/cvcs/HybridVideo_02.html) at the [Hybrid Video Product Department](https://intl.huaweicloud.com/en-us/product/cvcs.html), Huawei. Before that, Zongfang received his B.Eng degree with first-class honors from [Shandong University (SDU)](https://en.wikipedia.org/wiki/Shandong_University) in 2022. He won **three** awards in national-level competitions and got **six** scholarships during that time. His research on Computer Vision started at [SIAT, Chinese Academy of Science](https://siat-sz.edu.cn), under the supervision of [Dr.Fang Xu](https://scholar.google.com.hk/citations?hl=en&user=56qc93UAAAAJ&view_op=list_works&sortby=pubdate) and [Dr.Pengcheng Zhou](http://dami-lab.top/author/pengcheng-zhou/). Besides, he also worked with [Prof.John Roger Speakman](https://scholar.google.com/citations?user=nEVwdxoAAAAJ&hl=en) on biological experimental data analysis using ML&DL algorithms. He is passionate about developing and using algorithms to solve real problems.

## No way to retreat is the way to victory.
